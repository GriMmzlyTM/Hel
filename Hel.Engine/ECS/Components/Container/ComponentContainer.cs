...
namespace Hel.Engine.ECS.Components.Container
{
    /// <summary>
    ...
    public class ComponentContainer
    {
        ...
        /*private readonly ManagedArray<int> _removedEntities;
        private readonly ManagedArray<int> _addedEntities;
        private readonly ManagedArray<int> _updatedEntities;*/
        ...
        {
            if (_components[entityId] == null) return;
        ...
        public void ApplyUpdates()
        {
            ...
            //var nonNullRemoved = _removedEntities.GetNonNullIndexes();
