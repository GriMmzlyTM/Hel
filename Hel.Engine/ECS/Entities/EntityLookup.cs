...
namespace Hel.Engine.ECS.Entities
{
    ...
    {
        private ManagedArray<string> _entityTypeLookup;
        ...
        {
            return _entityTypeLookup.Add(name);
        }
        
        /// <summary>
        /// Add entity without name -> GUID name will be generated
        /// </summary>
        /// <returns></returns>
        public int Add()
        {
