...
{
    public class ComponentDictionary : IEnumerable, IEnumerable<KeyValuePair<Type, IComponent>>, IDictionary<Type, IComponent>
    {
        ...
        public bool GetComponentOrFail<T>(out T component) where T : struct, IComponent
        {
            ...
            return EqualityComparer<T>.Default.Equals(component, default(T)) ? false : true;
        }
